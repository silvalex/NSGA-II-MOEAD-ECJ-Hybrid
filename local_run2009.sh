for i in {1..5}; do
	mkdir ~/grid/2009-nsga-ii-moead-ecj-hybrid$i
	for j in {1..50}; do

		result=~/grid/2009-nsga-ii-moead-ecj-hybrid$i/out$j.stat
		analysis=~/grid/2009-nsga-ii-moead-ecj-hybrid$i/eval$j.stat
