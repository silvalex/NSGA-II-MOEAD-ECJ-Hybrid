...
public class WSCStatistics extends SimpleShortStatistics {
    ...
    public void postEvaluationStatistics(EvolutionState state){
        ...
        if (output)
            ...
            WSCInitializer.availIdx = 0;
            WSCInitializer.reliaIdx = 0;
            WSCInitializer.timeIdx = 0;
            WSCInitializer.costIdx = 0;
            state.output.print(WSCInitializer.meanAvailPerGen[WSCInitializer.availIdx++] + " ", statisticslog);
            state.output.print(WSCInitializer.meanReliaPerGen[WSCInitializer.reliaIdx++] + " ", statisticslog);
            ...
            state.output.print("" + ((SequenceVectorIndividual)popBestOfGeneration).getAvailability() + " ", statisticslog);
            state.output.print("" + ((SequenceVectorIndividual)popBestOfGeneration).getReliability() + " ", statisticslog);
            ...
            state.output.print("" + ((SequenceVectorIndividual)popBestSoFar).getAvailability() + " ", statisticslog);
            state.output.print("" + ((SequenceVectorIndividual)popBestSoFar).getReliability() + " ", statisticslog);
